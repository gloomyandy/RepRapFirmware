...
const SpiMode MAX31855_SpiMode = SpiMode::mode0;
...
GCodeResult ThermocoupleSensor31855::Configure(GCodeBuffer& gb, const StringRef& reply, bool& changed) THROWS(GCodeException)
{
