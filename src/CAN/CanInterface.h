...
namespace CanInterface
{
	...
	GCodeResult SetHandleDriveLevel(CanAddress boardAddress, RemoteInputHandle h, uint16_t driveLevel, uint8_t &returnedDriveLevel, const StringRef &reply) noexcept;
